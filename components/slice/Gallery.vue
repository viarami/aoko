<template>
  <div
    class="py-2 py-16 my-16 bg-gray-100 md:px-8 gallery-block md:my-32 dark-mode:bg-gray-900"
  >
    <div
      class="mb-8 text-3xl title dark-mode:text-white"
    ...
    <div v-if="slice.primary.column_number === '2'" class="two">
      <div v-for="item in slice.items" :key="item.id" class="mb-8">
        <ResponsiveImg
          ...
          :sizes="'(min-width: 768px) 50vw, 98vw'"
        />
      </div>
    </div>
