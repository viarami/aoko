<template>
  ...
  >
    ...
    <div
      ...
      class="fixed z-30 w-screen h-screen px-8 py-4 font-medium bg-gray-200 dark-mode:bg-gray-800 md:bg-transparent md:relative md:z-0 md:w-auto md:h-auto menu md:block"
    >
      ...
      <div
        class="w-1/2 mt-8 border-b-2 border-gray-800 dark-mode:border-gray-200 md:hidden line"
      ></div>
    </div>

    <div
      class="block py-4 pr-8 cursor-pointer menu-toggle md:hidden"
      @click="toogleMenu()"
    >
